...
&nbsp;
<span class="cstat-no" title="statement not covered" >        void this.handleResponseBody(resp.clone(), item).then(</span>
<span class="fstat-no" title="function not covered" >          (r</span>esponseValue: string | ArrayBuffer) =&gt; {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            this.sendMessage(item.getMessage())</span>
          },
        )
      }
&nbsp;
